...
const buttonVariants = cva(
  "inline-flex items-center justify-center whitespace-nowrap rounded-[4px] text-sm font-semibold ring-offset-background transition-colors focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50",
  {
    variants: {
      variant: {
        default: "bg-[#5625F2] text-white hover:bg-[#4118D4]",
        destructive:
          "bg-red-500 text-white hover:bg-red-600",
        outline:
          "border border-input bg-transparent hover:bg-[#F8F8FA] hover:text-[#1F2328]",
        secondary:
          "bg-[#F8F8FA] text-[#1F2328] hover:bg-[#F8F8FA]/80",
        ghost: "hover:bg-[#F8F8FA] hover:text-[#1F2328]",
        link: "text-[#5625F2] underline-offset-4 hover:underline",
      },
      size: {
